...
**  for the URL /reqcpulog in as follows:
**
**    #   httpd.conf
**    LoadModule reqcpulog_module modules/mod_reqcpulog.so
**    <Location /reqcpulog>
**    SetHandler reqcpulog
**    </Location>
**
...
**    $ apachectl restart
**
**  you immediately can request the URL /reqcpulog and watch for the
...
**  
**    The sample page from mod_reqcpulog.c
*/ 
...
static int reqcpulog_handler(request_rec *r)
{
    if (strcmp(r->handler, "reqcpulog")) {
        return DECLINED;
    }
    r->content_type = "text/html";      

    if (!r->header_only)
        ap_rputs("The sample page from mod_reqcpulog.c\n", r);
    return OK;
}

static void reqcpulog_register_hooks(apr_pool_t *p)
{
    ap_hook_handler(reqcpulog_handler, NULL, NULL, APR_HOOK_MIDDLE);
}
